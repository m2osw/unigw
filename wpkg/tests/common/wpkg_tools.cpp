...
{
    control_file_pointer_t ctrl(new wpkg_control::binary_control_file(std::shared_ptr<wpkg_control::control_file::control_file_state_t>(new wpkg_control::control_file::build_control_file_state_t)));
...
wpkg_filename::uri_filename wpkg_tools::get_root()
{
    return f_tmp_dir;
}

wpkg_filename::uri_filename wpkg_tools::get_target_path()
{
 ...
 */
void wpkg_tools::create_package(const std::string& name, control_file_pointer_t ctrl, bool reset_wpkg_dir )
{
...
void wpkg_tools::create_package( const std::string& name, control_file_pointer_t ctrl, int expected_return_value, bool reset_wpkg_dir )
{
...
std::string wpkg_tools::get_package_file_name( const std::string& name, control_file_pointer_t ctrl )
{
    return wpkg_util::make_safe_console_string(
                get_repository().append_child ("/"
                                              + name
                                              + "_"
                                              + ctrl->get_field("Version")
                                              + "_"
                                              + ctrl->get_field("Architecture")
                                              + ".deb"
                                              ).path_only()
                );
}
...
void wpkg_tools::install_package( const std::string& name, control_file_pointer_t ctrl )
{
    ...
    {
        cmd += " --root " + wpkg_util::make_safe_console_string(get_target_path().path_only());
    }
    cmd += " --install " + get_package_file_name( name, ctrl ); //wpkg_util::make_safe_console_string(get_repository().append_child("/" + name + "_" + ctrl->get_field("Version") + "_" + ctrl->get_field("Architecture") + ".deb").path_only());
...
void wpkg_tools::install_package( const std::string& name, control_file_pointer_t ctrl, int expected_return_value )
{
 ...
 */
void wpkg_tools::remove_package( const std::string& name, control_file_pointer_t ctrl )
{
    wpkg_filename::uri_filename root(get_root());
...
void wpkg_tools::remove_package( const std::string& name, control_file_pointer_t ctrl, int expected_return_value )
{
 ...
 * \param[in] ctrl  The control file fields.
 */
void wpkg_tools::purge_package( const std::string& name, control_file_pointer_t ctrl )
{
    wpkg_filename::uri_filename root(get_root());
    wpkg_filename::uri_filename target_path(root.append_child("target"));
...
void wpkg_tools::purge_package( const std::string& name, control_file_pointer_t ctrl, int expected_return_value )
{
